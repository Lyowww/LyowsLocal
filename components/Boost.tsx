...
import {
  calculateEnergyLimitUpgradeCost,
  calculateMultitapUpgradeCost,
  useGameStore,
...
export default function Boost({ currentView, setCurrentView }: BoostProps) {
  ...
  useEffect(() => {
    const isAvailable =
      energyRefillsLeft > 0 &&
      (energyRefillsLeft === MAX_ENERGY_REFILLS_PER_DAY || timeRemaining === 0);
    setIsEnergyRefillAvailable(isAvailable);
  }, [energyRefillsLeft, timeRemaining]);

  useEffect(() => {
    const isAffordable =
      calculateMultitapUpgradeCost(multitapLevelIndex) <= pointsBalance;
    setIsMultitapAffordable(isAffordable);
  }, [pointsBalance, multitapLevelIndex]);

  useEffect(() => {
    const isAffordable =
      calculateEnergyLimitUpgradeCost(energyLimitLevelIndex) <= pointsBalance;
              ...
              <div className="mt-4">
                ...
                >
                  ...
                  {isLoadingRefill ? (
                    ...
                    <span className="text-customGreen-700">Refill</span>
                  )}
                </button>
              </div>
              ...
              <div className="mt-4">
                ...
                >
                    ...
                    <div className="flex flex-col ml-2">
                      ...
                      <div className="flex justify-center items-center">
                        ...
                        <span className="ml-1 text-gray-500">
                          <span
                            className={`font-bold ${isMultitapAffordable ? "text-white" : ""
                              }`}
                          >
                            {formatNumber(
                              calculateMultitapUpgradeCost(multitapLevelIndex)
                            )}
                          </span>{" "}
                  ...
                  {isLoadingMultitap ? (
                    ...
                    <span className="text-customGreen-700">Upgrade</span>
                  )}
                </button>
                <button
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col ml-2">
                      ...
                      <div className="flex justify-center items-center">
                        ...
                        <span className="ml-1 text-gray-500">
                          <span
                            className={`font-bold ${isEnergyLimitAffordable ? "text-white" : ""
                              }`}
                          >
                            {formatNumber(
                              calculateEnergyLimitUpgradeCost(
